...
import { PageHead, KeyPoints, MarginContents } from "../components/editorial.jsx";
import { Seo } from "../lib/seo.jsx";

// The rail and the headings are driven from one list, so a section can never be
// in the margin and missing from the page, or the other way round.
const SECTIONS = [
  { id: "not-buy", label: "Not for sale" },
  { id: "why-links", label: "Links, not ads" },
  { id: "keep-honest", label: "Keep us honest" },
];
...
export default function Disclosure() {
  return (
    <div className="relative max-w-3xl mx-auto px-5 sm:px-6 py-10 sm:py-14 fade-in">
      ...
      {/* The answer to the question a sceptical reader actually arrived with,
          before the eight hundred words that support it. */}
      <KeyPoints points={[
        "Some outbound links pay us a commission. You pay the same price either way.",
        "No company can buy a review, a ranking, or a place on a list. There are no paid placements.",
        "We publish the downsides of every tool, including the ones that pay us the most.",
      ]} />
      ...
      <Reveal stagger className="space-y-5 text-lg leading-relaxed">
        ...
        <h2 id="keep-honest" className="font-display text-2xl font-semibold pt-4 scroll-mt-28">Keep us honest</h2>
